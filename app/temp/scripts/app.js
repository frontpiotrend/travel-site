...
var MobileMenu = function () {
	...
	function MobileMenu() {
		...
		this.siteHeader = (0, _jquery2.default)('.site-header'); //select entire site-header-element from the DOM
		this.menuIcon = (0, _jquery2.default)(".site-header__menu-icon"); //property/shortcut that's stores DOM selection for the menu-icon-element
		this.menuContent = (0, _jquery2.default)(".site-header__menu-content"); //shortcut to that current hidden div
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						...
						(0, _jquery2.default)(currentItem).addClass("reveal-item--is-visible"); /* add css modifier class */
					},
